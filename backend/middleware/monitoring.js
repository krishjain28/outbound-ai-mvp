...
class MonitoringService {
  ...
  trackCall(callData) {
    ...
    if (callData.duration) {
      ...
      this.metrics.calls.averageDuration = this.metrics.calls.totalDuration / this.metrics.calls.total;
    }
  }
  ...
  getHealthStatus() {
    ...
    const callSuccessRate = this.metrics.calls.total > 0 
  ...
  getOverallStatus() {
    ...
    if (errorRate > 10 || avgResponseTime > 10000 || this.metrics.system.memoryUsage > 90) {
      return 'unhealthy';
    } else if (errorRate > 5 || avgResponseTime > 5000 || this.metrics.system.memoryUsage > 80) {
      return 'degraded';
    } else {
      return 'healthy';
    }
