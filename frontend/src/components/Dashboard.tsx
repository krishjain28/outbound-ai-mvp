          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
            {quickActions.map((action, index) => (
              <Link
                key={action.title}
                to={action.href}
                className='card hover:shadow-lg transition-all duration-200 cursor-pointer animate-scale-in'
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <div className='card-body'>
                  <div
                    className={`w-12 h-12 ${action.bgColor} rounded-xl flex items-center justify-center mb-4`}
                  >
            ...
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-gray-600 mb-4'>
                  Set up your first campaign and start reaching out to prospects
